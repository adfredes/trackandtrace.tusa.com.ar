...
Partial Class ea_listado
    ...
    Sub cargar()
        ...
        oComm.CommandText = "af_listadoeea"
    ...
    Protected Sub gvListado_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvListado.RowDataBound
        If (e.Row.RowType = DataControlRowType.DataRow) Then           
            e.Row.Attributes("onclick") = "javascript:window.OpenModalAngular('FFModal',{title:'Exportación Aerea' , value:'ea_detalle.aspx?pcp=" & Trim(e.Row.Cells(0).Text) & "'});"
        End If
    End Sub

    Protected Sub gvListado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gvListado.SelectedIndexChanged
