<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="em_listado.aspx.vb" Inherits="em_listado" Title="Exportación Marítima - Listado" %>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="div-listado">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Operaci&#243;n" DataField="hme_numeroint">
                                    <HeaderStyle Width="10%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Origen" DataField="pue_origen">
                                    <HeaderStyle Width="6%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Destino" DataField="pue_destino">
                                    <HeaderStyle Width="6%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Agente" DataField="age_descripcion">
                                    <HeaderStyle Width="18%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Referencia" DataField="hme_referencia">
                                    <HeaderStyle Width="28%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Kg. Brutos" DataField="hme_kgbrutos">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                            </Columns>
                        </asp:GridView>
