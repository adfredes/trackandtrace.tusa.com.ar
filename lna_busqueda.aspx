<%@ Page Title="CT&T - Seguimiento LNAs" Language="VB" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="false" CodeFile="lna_busqueda.aspx.vb" Inherits="lna_busqueda" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
    <asp:Panel ID="Panel1" runat="server" DefaultButton="ibBuscar" CssClass="form-buscador">
...
<asp:TextBox ID="txtDesde" runat="server" CssClass="form-control form-control-sm" Width="105px"></asp:TextBox>
            ...
            <div class="form-group mr-1 form-check">
                <asp:CheckBox ID="chkCanceladas" runat="server" />
                <label>
                    Canceladas</label>
            </div>
            <div class="form-group mr-1 form-check">
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        PagerStyle-HorizontalAlign="left" PagerSettings-Position="TopAndBottom"> 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="fecha_finalizado" DataFormatString="{0:d}" HeaderText="Fin Bloqueo">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="vto_lna" DataFormatString="{0:d}" HeaderText="Vto LNA">
                                    </asp:BoundField>
                                    <asp:BoundField DataField="NroTramiteLNA" HeaderText="Nro Trámite"></asp:BoundField>
                                    <asp:BoundField DataField="estado" HeaderText="Estado LNA"></asp:BoundField>
                                    <asp:BoundField DataField="observaciones" HeaderText="Observaciones"></asp:BoundField>
                                    <asp:BoundField DataField="estado_declaracion" HeaderText="Estado SIMI"></asp:BoundField>
                                </Columns>                                
                            </asp:GridView>
                </div>
