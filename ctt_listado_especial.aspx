<%@ Page Title="CT&T - Listado Especial" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="ctt_listado_especial.aspx.vb" Inherits="ctt_listado_especial" %>
    ...
    <asp:Panel ID="pnlBuscador" runat="server" Wrap="true" CssClass="form-buscador" DefaultButton="ibBuscar">
        ...
        <asp:TextBox ID="txtDesde" runat="server" CssClass="form-control form-control-sm" Width="105px"></asp:TextBox>
            ...
            <div class="form-group mr-1 form-check">
                <asp:CheckBox ID="chkLiq" runat="server" CssClass="" />
                <label>
                    xLiquidación Conceptos</label>
            </div>
