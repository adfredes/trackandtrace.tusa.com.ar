<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ia_listado.aspx.vb" Inherits="ia_listado" %>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="div-listado">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Operaci&#243;n" DataField="hai_numeroint">
                                    <HeaderStyle Width="10%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="HAWB" DataField="hai_hawb">
                                    <HeaderStyle Width="7.5%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Orig." DataField="aer_origen">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Dest." DataField="aer_destino">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField HeaderText="Ref." DataField="hai_referencia">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Kg. Af." DataField="hai_kgaforado">
                                    <HeaderStyle Width="6%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Fecha Llegada" DataField="fec_alta">
