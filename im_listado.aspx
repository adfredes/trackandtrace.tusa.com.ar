<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="im_listado.aspx.vb" Inherits="im_listado" Title="Importación Marítima - Listado" %>
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="div-listado">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Operaci&#243;n" DataField="hmi_numeroint">
                                    <HeaderStyle Width="10%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="H/HBL" DataField="hmi_hbl">
                                    <HeaderStyle Width="7.5%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Orig." DataField="pue_origen">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Dest." DataField="pue_destino">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Proveedor" DataField="prx_descripcion">
                                    <HeaderStyle Width="20%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Agente" DataField="age_descripcion">
                                    <HeaderStyle Width="30%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Ref." DataField="hmi_referencia">
                                    <HeaderStyle Width="4%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Kg. Brutos" DataField="hmi_kgbruto">
                                    <HeaderStyle Width="6%" />
                                </asp:BoundField>
                                <asp:BoundField HeaderText="Fecha Llegada" DataField="mmi_fecllega">
