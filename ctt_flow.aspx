...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="form-inline">
            ...
            <div class="form-group mr-1">
                <asp:DropDownList ID="DropDownList4" runat="server" CssClass="form-control form-control-sm">
                    <asp:ListItem Value="__portación">[Tipo Operaci&#243;n]</asp:ListItem>
                    <asp:ListItem Value="Importación">Importaci&#243;n</asp:ListItem>
                    <asp:ListItem Value="Exportación">Exportaci&#243;n</asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="form-group mr-1">
                <asp:DropDownList ID="ddlDeposito" runat="server" CssClass="form-control form-control-sm">                    
                </asp:DropDownList>
            </div>
            <div class="form-group mr-1">
            ...
            <div class="form-group mr-1">
                <asp:DropDownList ID="ddlTransporte" runat="server" CssClass="form-control form-control-sm">                    
                </asp:DropDownList>
            </div>
            <div class="form-group mr-1">
    ...
    <md-tabs md-dynamic-height md-border-bottom>
      ...
      <md-tab label="Deposito" onClick="mostrar('dDeposito')">
      </md-tab>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:Panel ID="pGraficos" runat="server">
                    ...
                    <div id="dDeposito" style="page-break-after: always;" class="OcultarDivGrafico">
                        <fieldset>
                            <h4 class="p-4 d-none">x DEPOSITO</h4>
                            <asp:GridView ID="GridView14" runat="server" BackColor="White" BorderColor="#CCCCCC"
                                BorderStyle="None" BorderWidth="1px" CellPadding="3" PageSize="20" Width="100%">
                                <RowStyle ForeColor="#000066" />
                                <FooterStyle BackColor="White" ForeColor="#000066" />
                                <PagerStyle BackColor="White" ForeColor="#000066" HorizontalAlign="Left" />
                            ...
                            <br />
                            <asp:Chart ID="Chart14" runat="server" Width="627px" EnableViewState="True">
                                <ChartAreas>
                                    <asp:ChartArea Name="ChartArea1">
                                    </asp:ChartArea>
                                </ChartAreas>
